...
// Verificar conexión<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="app-container">
        ...
        <div id="home" class="page active">
            <header class="app-header">
                <div class="header-content">
                    ...
                    <div class="app-subtitle">Tu jardín inteligente y sincronizado</div>
            ...
            <main class="main-content">
                ...
                <!-- Plants Section - Modificado para carga dinámica -->
                <section class="card">
                ...
                <section class="card">
                    ...
                    <div class="notifications-list">
                        ...
                        <div class="notification notification-info">
                            <div class="notification-content">
                                <div class="notification-text"><i class="fas fa-info-circle"></i> Consejo: Tiempo ideal para riego</div>
        ...
        <div id="diagnosis" class="page">
            <header class="app-header">
                 <div class="header-content">
                    <div class="app-title">Diagnóstico IA</div>
                    <div class="app-subtitle">Detecta problemas en tus plantas</div>
                </div>
            </header>
            <main class="main-content">
                ...
                <section class="card">
                    ...
                    <div class="analysis-results">
                        <div class="analysis-card analysis-warning">
                            ...
                            <p>Observa de cerca las hojas jóvenes y los brotes.</p>
                        </div>
                        <div class="analysis-card analysis-success">
                            <div class="analysis-header">
                                <span class="analysis-emoji"><i class="fas fa-shield-alt"></i></span>
                                <h4 class="analysis-title">Tratamiento Sugerido</h4>
                            </div>
                            <p>Aplicar una mezcla de aceite de neem y jabón potásico.</p>
                            <button class="treatment-btn"><i class="fas fa-book-medical"></i> Ver Instrucciones Detalladas</button>
                        </div>
                    </div>
                </section>
                <section class="card">
                    <div class="section-header">
                        <span class="section-emoji"><i class="fas fa-graduation-cap"></i></span>
                        <h3 class="section-title">Aprende Jugando</h3>
                    </div>
                    <div class="learning-grid">
                        <div class="learning-card">
                            <span class="learning-emoji"><i class="fas fa-bug"></i></span>
                            <h4>Quiz de Plagas</h4>
                            <p>Pon a prueba tus conocimientos.</p>
                        </div>
                        <div class="learning-card">
                             <span class="learning-emoji"><i class="fas fa-book-open"></i></span>
                            <h4>Guías de Cultivo</h4>
                            <p>Consejos para cada planta.</p>
                        </div>
                    </div>
                </section>
            </main>
        ...
        <div id="compost" class="page">
            <header class="app-header">
                <div class="header-content">
                    <div class="app-title">Compostaje Pro <i class="fas fa-recycle"></i></div>
                    <div class="app-subtitle">Calcula y aprende a compostar</div>
                </div>
            </header>
            <main class="main-content">
                <div class="page-header">
        ...
        <div id="assistant" class="page">
            <header class="app-header">
                <div class="header-content">
                    <div class="app-title">Asistente IA <i class="fas fa-brain"></i></div>
                    <div class="app-subtitle">Tu consejero agrícola personal</div>
                </div>
            </header>
            <main class="main-content">
                 <div class="page-header">
                ...
                <section class="card" style="padding: 0; overflow:visible;"> <!-- Ajuste para que el chat use todo el espacio de la card -->
        ...
        <div id="profile" class="page">
            <header class="app-header">
                 <div class="header-content">
                    ...
                    <div class="app-subtitle">Agricultor Urbano Apasionado</div>
                </div>
            </header>
            <main class="main-content">
                <section class="profile-info">
                    ...
                    <p class="profile-level">Nivel 5 • 1,250 XP <i class="fas fa-star" style="color: var(--warning);"></i></p>
                </section>
                ...
                <section class="card">
                    <div class="section-header">
                        <span class="section-emoji"><i class="fas fa-trophy"></i></span>
                        <h3 class="section-title">Mis Logros</h3>
                    </div>
                    <div class="achievements-grid">
                        <div class="achievement-item">
                            <span class="achievement-emoji" style="color: var(--primary-green);">🌱</span>
                            <div class="achievement-name">Primera Siembra Exitosa</div>
                        </div>
                        <div class="achievement-item">
                            <span class="achievement-emoji" style="color: var(--primary-blue);">🧠</span>
                            <div class="achievement-name">Diagnóstico Experto IA</div>
                        </div>
                        <div class="achievement-item">
                            <span class="achievement-emoji" style="color: var(--accent-purple);">🤝</span>
                            <div class="achievement-name">Colaborador Comunitario</div>
                        </div>
                         <div class="achievement-item">
                            <span class="achievement-emoji" style="color: var(--warning);">♻️</span>
                            <div class="achievement-name">Maestro del Compost</div>
                        </div>
                    </div>
                </section>
                <section class="card">
                    ...
                    <div class="settings-list">
                        <div class="setting-item">
                             <div class="setting-info">
                                ...
                                <p>Recibir alertas y consejos.</p>
                            </div>
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                <h4>Modo Oscuro</h4>
                                <p>Alternar tema claro/oscuro.</p>
                            </div>
                            <div class="toggle-switch" id="darkModeToggleContainer" onclick="document.getElementById('darkModeToggle').click(); this.classList.toggle('active');">
                        ...
                        <div class="setting-item">
                            <div class="setting-info">
                                <h4>Permiso de Ubicación</h4>
                                <p>Para clima y servicios locales.</p>
                            </div>
                           <div class="toggle-switch active" id="locationToggleContainer" onclick="document.getElementById('locationToggle').click(); this.classList.toggle('active');">
                ...
                <section class="ai-assistant">
                    <div class="assistant-header">
                        <span class="section-emoji"><i class="fas fa-robot"></i></span>
                        <h3 class="section-title">Asistente IA AgroSync</h3>
                    </div>
                    <div class="assistant-content">
                        <p>¡Hola! Soy tu asistente agrícola personal. ¿Tienes alguna pregunta sobre tus cultivos o necesitas algún consejo?</p>
                        <button class="assistant-btn" onclick="showPage('assistant')"><i class="fas fa-comment-dots"></i> Chatear Ahora</button>
                    </div>
                </section>
            </main>
        </div>
    ...
    <script src="js/plants.js"></script> <!-- Nuevo script para plantas -->
